...
<html id="computer" lang="en">
	<head>
		...
		<meta charset="utf-8">
		<link rel="apple-touch-icon" sizes="57x57" href="img/favicon/apple-touch-icon-57x57.png?v=3">
        <link rel="apple-touch-icon" sizes="60x60" href="img/favicon/apple-touch-icon-60x60.png?v=3">
        <link rel="apple-touch-icon" sizes="72x72" href="img/favicon/apple-touch-icon-72x72.png?v=3">
        <link rel="apple-touch-icon" sizes="76x76" href="img/favicon/apple-touch-icon-76x76.png?v=3">
        <link rel="apple-touch-icon" sizes="114x114" href="img/favicon/apple-touch-icon-114x114.png?v=3">
        <link rel="apple-touch-icon" sizes="120x120" href="img/favicon/apple-touch-icon-120x120.png?v=3">
        <link rel="apple-touch-icon" sizes="144x144" href="img/favicon/apple-touch-icon-144x144.png?v=3">
        <link rel="apple-touch-icon" sizes="152x152" href="img/favicon/apple-touch-icon-152x152.png?v=3">
        <link rel="apple-touch-icon" sizes="180x180" href="img/favicon/apple-touch-icon-180x180.png?v=3">
        <link rel="icon" type="image/png" href="img/favicon/favicon-32x32.png?v=3" sizes="32x32">
        <link rel="icon" type="image/png" href="img/favicon/favicon-194x194.png?v=3" sizes="194x194">
        <link rel="icon" type="image/png" href="img/favicon/favicon-96x96.png?v=3" sizes="96x96">
        <link rel="icon" type="image/png" href="img/favicon/android-chrome-192x192.png?v=3" sizes="192x192">
        ...
        <link rel="mask-icon" href="img/favicon/safari-pinned-tab.svg?v=3" color="#57b76e">
        ...
        <script type="text/javascript" src="js/scripts.min.js?v=3"></script>
	</head>
	<body>
    	<div id="terminal">
